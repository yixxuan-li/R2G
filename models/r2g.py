...
nr3d_vocab_set = ['above', 'alarm', 'allocentric', 'armchair', 'back', 'backpack', 'bag', 'ball', 'banana', 'banner', 'bar', 'basket', 'bath', 'bathroom', 'bathtub', 'beanbag', 'beans', 'bear', 'bed', 'beer', 'below', 'bench', 'between', 'bicycle', 'bike', 'bin', 'black', 'blackboard', 'blanket', 'blinds', 'block', 'blue', 'board', 'book', 'bookshelf', 'bottle', 'bottom', 'bowl', 'box', 'boxes', 'brown', 'bucket', 'bulletin', 'bunk', 'cabinet', 'calendar', 'camera', 'can', 'car', 'cardboard', 'carpet', 'cart', 'case', 'cat', 'cd', 'ceiling', 'chair', 'changing', 'chest', 'clock', 'closest', 'closet', 'cloth', 'clothes', 'clothing', 'coat', 'coffee', 'column', 'compost', 'conditioner', 'container', 'cooking', 'copier', 'corner', 'couch', 'counter', 'covered', 'crate', 'cup', 'curtain', 'curve', 'cushion', 'cutting', 'dart', 'decoration', 'desk', 'diaper', 'dining', 'dish', 'dishwasher', 'dishwashing', 'dispenser', 'display', 'dolly', 'door', 'drawer', 'dress', 'dresser', 'drum', 'dryer', 'drying', 'duffel', 'easel', 'electric', 'elevator', 'elliptical', 'end', 'envelope', 'exercise', 'exit', 'fan', 'farthest', 'faucet', 'file', 'fire', 'fireplace', 'floor', 'flower', 'folded', 'folder', 'food', 'foosball', 'footrest', 'footstool', 'frame', 'front', 'frying', 'furniture', 'fuse', 'futon', 'garage', 'garbage', 'glass', 'globe', 'gold', 'golf', 'grab', 'green', 'grey', 'grocery', 'guitar', 'hair', 'hamper', 'hand', 'handicap', 'hanging', 'hat', 'headboard', 'headphones', 'heater', 'hockey', 'ikea', 'instrument', 'ironing', 'jacket', 'keyboard', 'kitchen', 'ladder', 'lamp', 'laptop', 'large', 'laundry', 'ledge', 'leftmost', 'legs', 'light', 'loft', 'long', 'lower', 'luggage', 'lunch', 'machine', 'magazine', 'mail', 'map', 'massage', 'mat', 'mattress', 'messenger', 'microwave', 'middle', 'mini', 'mirror', 'mixer', 'monitor', 'mouse', 'mouthwash', 'mug', 'music', 'nerf', 'night', 'nightstand', 'notepad', 'object', 'office', 'orange', 'organizer', 'ottoman', 'oven', 'pad', 'painting', 'pantry', 'paper', 'person', 'photo', 'piano', 'picture', 'pillar', 'pillow', 'ping', 'pink', 'pipe', 'pizza', 'plant', 'plastic', 'pool', 'poster', 'pot', 'potted', 'power', 'printer', 'projector', 'purple', 'purse', 'rack', 'radiator', 'rail', 'range', 'recliner', 'recycling', 'red', 'refrigerator', 'remote', 'rice', 'rightmost', 'rod', 'rolled', 'roomba', 'round', 'rug', 'screen', 'seat', 'sewing', 'shampoo', 'shelf', 'shirt', 'shoe', 'shopping', 'short', 'shorts', 'shower', 'sign', 'sink', 'sliding', 'sliver', 'small', 'smoke', 'soap', 'soda', 'sofa', 'spray', 'stack', 'stair', 'stall', 'stand', 'starbucks', 'statue', 'step', 'sticker', 'stool', 'storage', 'stove', 'stuffed', 'suitcase', 'support', 'supported', 'sweater', 'switch', 'table', 'tall', 'tank', 'tea', 'teddy', 'telephone', 'thermostat', 'tissue', 'toaster', 'toilet', 'top', 'towel', 'toy', 'traffic', 'trash', 'tray', 'tv', 'umbrella', 'vacuum', 'vanity', 'vase', 'vending', 'vent', 'wall', 'wardrobe', 'washing', 'water', 'wet', 'white', 'whiteboard', 'window', 'windowsill', 'wood', 'yellow', 'yoga']
...
sr3d_vocab_set = ['above', 'alarm', 'allocentric', 'armchair', 'back', 'backpack', 'bad', 'bag', 'ball', 'banana', 'banner', 'bar', 'basket', 'bath', 'bathroom', 'bathtub', 'beanbag', 'beans', 'bear', 'bed', 'beer', 'below', 'bench', 'between', 'bicycle', 'bike', 'bin', 'black', 'blackboard', 'blanket', 'blinds', 'block', 'blue', 'board', 'book', 'bookshelf', 'bottle', 'bottom', 'bowl', 'box', 'boxes', 'brown', 'bucket', 'bulletin', 'bunk', 'cabinet', 'calendar', 'camera', 'can', 'car', 'cardboard', 'carpet', 'cart', 'case', 'cat', 'cd', 'ceiling', 'chair', 'changing', 'chest', 'clock', 'closest', 'closet', 'cloth', 'clothing', 'coat', 'coffee', 'column', 'compost', 'conditioner', 'container', 'cooking', 'copier', 'corner', 'couch', 'counter', 'covered', 'crate', 'cup', 'curtain', 'curve', 'cushion', 'cutting', 'dart', 'decoration', 'desk', 'diaper', 'dining', 'dish', 'dishwasher', 'dishwashing', 'dispenser', 'display', 'dolly', 'door', 'drawer', 'dress', 'dresser', 'drum', 'dryer', 'drying', 'duffel', 'easel', 'electric', 'elevator', 'elliptical', 'end', 'envelope', 'exercise', 'exit', 'fan', 'farthest', 'faucet', 'file', 'fire', 'fireplace', 'floor', 'flower', 'folded', 'folder', 'food', 'foosball', 'footrest', 'footstool', 'frame', 'front', 'frying', 'furniture', 'fuse', 'futon', 'garage', 'garbage', 'glass', 'globe', 'gold', 'golf', 'grab', 'green', 'grey', 'grocery', 'guitar', 'hair', 'hamper', 'hand', 'handicap', 'hanging', 'hat', 'headboard', 'headphones', 'heater', 'hockey', 'holder', 'ikea', 'instrument', 'ironing', 'jacket', 'keyboard', 'kitchen', 'ladder', 'lamp', 'laptop', 'large', 'laundry', 'ledge', 'leftmost', 'legs', 'light', 'loft', 'long', 'lower', 'luggage', 'lunch', 'machine', 'magazine', 'mail', 'map', 'massage', 'mat', 'mattress', 'messenger', 'microwave', 'middle', 'mini', 'mirror', 'mixer', 'monitor', 'mouse', 'mouthwash', 'mug', 'music', 'nerf', 'night', 'nightstand', 'notepad', 'object', 'office', 'orange', 'organizer', 'ottoman', 'oven', 'pad', 'painting', 'pan', 'pantry', 'paper', 'person', 'photo', 'piano', 'picture', 'pillar', 'pillow', 'ping', 'pink', 'pipe', 'pizza', 'plant', 'plastic', 'pool', 'poster', 'pot', 'potted', 'power', 'printer', 'projector', 'purple', 'purse', 'rack', 'radiator', 'rail', 'railing', 'range', 'recliner', 'recycling', 'red', 'refrigerator', 'remote', 'rice', 'rightmost', 'rod', 'rolled', 'round', 'rug', 'screen', 'seat', 'sewing', 'shampoo', 'shelf', 'shirt', 'shoe', 'shopping', 'short', 'shorts', 'shower', 'sign', 'sink', 'sliding', 'sliver', 'small', 'smoke', 'soap', 'soda', 'sofa', 'spray', 'stack', 'stair', 'stall', 'stand', 'starbucks', 'statue', 'step', 'sticker', 'stool', 'storage', 'stove', 'stream', 'stuffed', 'suitcase', 'support', 'supported', 'sweater', 'switch', 'table', 'tall', 'tank', 'tea', 'teddy', 'telephone', 'thermostat', 'tissue', 'toaster', 'toilet', 'top', 'towel', 'toy', 'traffic', 'trash', 'tray', 'tv', 'umbrella', 'vacuum', 'vanity', 'vase', 'vending', 'vent', 'wall', 'wardrobe', 'washing', 'water', 'wet', 'white', 'whiteboard', 'window', 'windowsill', 'wood', 'yellow', 'yoga']
class R2G(nn.Module):
    """
