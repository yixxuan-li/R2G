...
sr3d_class_set = ['alarm', 'armchair', 'backpack', 'bad', 'bag', 'ball', 'banner', 'bar', 'basket', 'bathtub', 'bear', 'bed', 'bench', 'bicycle', 'bike', 'bin', 'blackboard', 'blanket', 'blinds', 'board', 'book', 'bookshelf', 'bottle', 'bowl', 'box', 'bucket', 'cabinet', 'calendar', 'camera', 'can', 'car', 'cardboard', 'carpet', 'cart', 'case', 'ceiling', 'chair', 'chest', 'clock', 'closet', 'cloth', 'clothing', 'coat', 'column', 'container', 'copier', 'couch', 'counter', 'crate', 'cup', 'curtain', 'cushion', 'decoration', 'desk', 'dishwasher', 'dispenser', 'display', 'dolly', 'door', 'drawer', 'dresser', 'easel', 'fan', 'faucet', 'fireplace', 'floor', 'folder', 'footrest', 'footstool', 'frame', 'furniture', 'futon', 'globe', 'guitar', 'hamper', 'hanging', 'hat', 'headboard', 'headphones', 'heater', 'holder', 'jacket', 'keyboard', 'ladder', 'lamp', 'laptop', 'ledge', 'legs', 'light', 'luggage', 'machine', 'magazine', 'mail', 'map', 'mat', 'mattress', 'microwave', 'mirror', 'monitor', 'mouse', 'mug', 'nightstand', 'notepad', 'object', 'ottoman', 'oven', 'pad', 'painting', 'pan', 'paper', 'person', 'photo', 'piano', 'picture', 'pillar', 'pillow', 'pipe', 'plant', 'poster', 'pot', 'printer', 'projector', 'purse', 'rack', 'radiator', 'rail', 'railing', 'refrigerator', 'rod', 'rug', 'screen', 'seat', 'shampoo', 'shelf', 'shirt', 'shoe', 'shorts', 'shower', 'sign', 'sink', 'soap', 'stair', 'stall', 'stand', 'statue', 'step', 'sticker', 'stool', 'stove', 'stream', 'suitcase', 'sweater', 'switch', 'table', 'tank', 'telephone', 'thermostat', 'toaster', 'toilet', 'towel', 'tray', 'tv', 'umbrella', 'vase', 'vent', 'wall', 'wardrobe', 'whiteboard', 'window', 'windowsill', 'wood']
sr3d_function_set = ['alarm', 'ball', 'banana', 'bar', 'basket', 'bath', 'bathroom', 'beanbag', 'beans', 'beer', 'bike', 'block', 'book', 'bottle', 'boxes', 'bulletin', 'bunk', 'cabinet', 'cat', 'cd', 'chair', 'changing', 'closet', 'cloth', 'coat', 'coffee', 'compost', 'conditioner', 'cooking', 'couch', 'counter', 'covered', 'cushion', 'cutting', 'dart', 'desk', 'diaper', 'dining', 'dish', 'dishwashing', 'display', 'dress', 'drum', 'dryer', 'drying', 'duffel', 'electric', 'elevator', 'elliptical', 'end', 'envelope', 'exercise', 'exit', 'fan', 'file', 'fire', 'flower', 'folded', 'food', 'foosball', 'frying', 'fuse', 'futon', 'garage', 'garbage', 'glass', 'golf', 'grab', 'grocery', 'guitar', 'hair', 'hand', 'handicap', 'hockey', 'ikea', 'instrument', 'ironing', 'keyboard', 'kitchen', 'lamp', 'laundry', 'light', 'loft', 'luggage', 'lunch', 'magazine', 'mail', 'massage', 'messenger', 'mini', 'mirror', 'mixer', 'mouthwash', 'music', 'nerf', 'night', 'office', 'organizer', 'oven', 'pad', 'pantry', 'paper', 'piano', 'ping', 'pizza', 'plastic', 'pool', 'poster', 'potted', 'power', 'projector', 'rack', 'range', 'recliner', 'recycling', 'remote', 'rice', 'rolled', 'round', 'sewing', 'shampoo', 'shoe', 'shopping', 'shower', 'sliding', 'smoke', 'soap', 'soda', 'sofa', 'spray', 'stack', 'stair', 'stall', 'starbucks', 'step', 'storage', 'stuffed', 'tea', 'teddy', 'tissue', 'toaster', 'toilet', 'towel', 'toy', 'traffic', 'trash', 'tray', 'tv', 'vacuum', 'vanity', 'vending', 'wall', 'wardrobe', 'washing', 'water', 'wet', 'whiteboard', 'wood', 'yoga']
class R2G(nn.Module):
    """
...
def create_r2g_net(args: argparse.Namespace, vocab: Vocabulary, n_obj_classes: int, class_to_index: dict) -> nn.Module:
    ...
    if 'sr3d' in args.referit3D_file:
        ...
        object_class_set = sr3d_class_set
        function_set = sr3d_function_set
    elif 'nr3d' in args.referit3D_file:
        object_class = object_class1
        my_function = my_function1
        object_class_set = nr3d_class_set
        function_set = nr3d_function_set
