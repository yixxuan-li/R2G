...
def token_encoder(vocab: Vocabulary,
                  ...
                  feature_type='max',
                  glove_emb_file: str = '/home/yixuan/data/R2G/glove.6B.300d.txt') -> LSTMEncoder:#/data1/liyixuan/glove/glove.6B.300d.txt
    """
...
def token_embeder(vocab: Vocabulary,
                  word_embedding_dim: int,
                  random_seed=None,
                  glove_emb_file: str = '/home/yixuan/data/R2G/glove.6B.300d.txt') -> LSTMEncoder:
    """
    Language Token Encoder.
