...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        for i_index in range(len(vis_res)): ##i_index: per utturance index
            ...
            #     continue
            # if "scene0025_00" not in vis_res[i_index]['scan_id']:
            #     continue
            ...
            for i in range(5):
                ins1= {}
                for j in range(20):
                    ins1[vocabs[vis_res[i_index]['ins_simi_index'][0, j]]] = vis_res[i_index]['ins_simi'][0, j].tolist()
                ins_simi[i] = ins1
