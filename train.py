    ...
    if args.mode == 'train':
        ...
        for i_index in range(len(vis_res)): ##i_index: per utturance index
            ...
            for i in range(vis_res[i_index]['context_size']):
                ...
                simi = {}
                for j in range(20):
                    simi[str(j) + object_class1[vis_res[i_index]['simi_index'][i][j]]] = vis_res[i_index]['simi'][i][j].tolist()
